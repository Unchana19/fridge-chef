                    ...
                    <div className="bg-content1/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-divider/50">
                      ...
                      <div className="flex flex-wrap gap-2.5">
                        {result.ingredients_detected.map((item, i) => (
                          <span
                            key={`ingredient-${item}`}
                            className="px-4 py-2 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-full text-sm font-medium text-foreground border border-primary/20 animate-fade-in capitalize"
